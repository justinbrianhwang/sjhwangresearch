...
const PAST_PROJECTS = [
  ...
  },
  {
    ...
    description: {
      en: "Trained heterogeneous models via federated learning in the same driving environment. Analyzed knowledge transfer between models and performance convergence across architectures.",
      ko: "동일한 주행 환경에서 이기종(Heterogeneous) 모델들을 연합학습으로 훈련한 연구. 모델 간 지식 전이와 다양한 아키텍처 간 성능 수렴을 분석.",
      ja: "同一の走行環境で異種モデルを連合学習で訓練。モデル間の知識転移とアーキテクチャ間の性能収束を分析。",
  ...
  },
  {
    ...
    description: {
      en: "Homogeneous federated learning research using TCP autonomous driving models across different driving environments. Trained the same TCP model in diverse scenarios via FL to analyze robustness and performance convergence under environment heterogeneity. Conducted as an undergraduate research course.",
      ko: "서로 다른 주행 환경에서 TCP 자율 주행 모델을 활용한 동질적(Homogeneous) 연합 학습 연구. 다양한 시나리오에서 동일 TCP 모델을 FL로 훈련하여 환경 이질성에 대한 강건성과 성능 수렴을 분석. 학부 연구 수업 과제로 진행하여 마무리.",
      ja: "異なる走行環境でTCP自律走行モデルを活用した同種連合学習の研究。学部研究授業の課題として完了。",
      es: "Investigación de FL homogéneo con modelos TCP en diferentes entornos. Realizado como curso de investigación de pregrado."
    },
    year: "2026",
    outcome: { en: "Completed (Undergraduate Research Course)", ko: "완료 (학부 연구 수업)", ja: "完了（学部研究授業）", es: "Completado (Curso de investigación de pregrado)" },
